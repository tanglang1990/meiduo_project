...
_accountSid = '8a48b55152f73add015310e843932e3c'

# 说明：主账号Token，登陆云通讯网站后，可在控制台-应用中看到开发者主账号AUTH TOKEN
_accountToken = '139905b603394f9eb08b412e8a5b0889'

# 请使用管理控制台首页的APPID或自己创建应用的APPID
_appId = 'aaf98f8952f7367a015310f7f5db2ec8'
...
if __name__ == '__main__':
    ...
    # 单例类发送短信验证码
    CCP().send_template_sms('18390839708', ['123456', 5], 1)
